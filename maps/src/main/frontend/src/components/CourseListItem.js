  ...
  return (
    <>
      ...
      <div
        className="list-item"
        onClick={() => {
          handleDetailsClick(course.courseId);
        }}
      >
          ...
          <div className="map-content-container">
            ...
            <div className="map-content-item">
              <img
                ...
                width="26"
                height="26"
                src="../images/agegroup.png"
                alt="age-group"
              />
              <p>
                Age group: <span className="bold">{course.ageGroup}</span>{" "}
              </p>
            </div>
            ...
            <div className="map-content-item">
              ...
              />
              <p>
                Controls: <span className="bold">{course.controls}</span>
              </p>
            </div>
            ...
            <div className="map-content-item">
              ...
              />
              <p>
                Distance <span className="bold">{course.distance} km</span>
              </p>
            </div>
